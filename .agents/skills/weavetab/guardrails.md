...
3. **When to use GitHub Tools**: Only use `browser_github` (with `action: "analyze"`, `"read"`, `"issues"`, or `"pr"`) for remote repositories that are NOT in your local workspace and when you specifically need to interact with GitHub issues or PRs.